...
<html lang="en">
    <head>
        ...
        <link rel="apple-touch-icon" sizes="76x76" href="{{url(pu./assets/favicon/apple-touch-icon.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="{{url(pu./assets/favicon/favicon-32x32.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="{{url(pu./assets/favicon/favicon-16x16.png" />
        <link rel="manifest" href="{{url(pu./assets/favicon/site.webmanifest" />
        <link rel="mask-icon" href="{{url(pu./assets/favicon/safari-pinned-tab.svg" color="#5bbad5" />
        <meta name="msapplication-TileColor" content="#da532c" />
        <meta name="theme-color" content="#ffffff" />

        <!-- Font  -->
        <link rel="stylesheet" href="{{url(pu./assets/fonts/stylesheet.css" />

        <!-- Styles -->
        <link rel="stylesheet" href="{{url(pu./assets/css/main.css" />
