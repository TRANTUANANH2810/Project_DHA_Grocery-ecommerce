...
<html lang="en">
    <head>
        ...
        <link rel="apple-touch-icon" sizes="76x76" href="{{url(public./assets/favicon/apple-touch-icon.png" />
        ...
        <link rel="mask-icon" href="{{url(public./assets/favicon/safari-pinned-tab.svg" color="#5bbad5" />
        <meta name="msapplication-TileColor" content="#da532c" />
        <meta name="theme-color" content="#ffffff" />

        <!-- Font  -->
        <link rel="stylesheet" href="{{url(public./assets/fonts/stylesheet.css" />
