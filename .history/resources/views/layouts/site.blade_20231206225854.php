            ...
            <div class="top-bar">
                ...
                <nav id="navbar" class="navbar hiden">
                    <button class="icon navbar__close-btn js-toggle" toggle-target="#navbar">
                        <img class="icon" src="./assets/icons/arrow-left.svg" alt="arrow-left" />
                    </button>
                                        ...
                                        <div class="top-menu__main">
                                            ...
                                            <div class="menu-column">
                                                <div class="menu-column__icon d-lg-none">
                                                    <img
                                                        src="./assets/img/categoris/cate-1.1.svg"
                                                        alt=""
                                                        class="menu-column__icon-1"
                                                    />
                                                    <img
                                                        src="./assets/img/categoris/cate-1.2.svg"
                                                        alt=""
                                                            ...
                                                            <div class="sub-menu">
                                                                <div class="sub-menu__column">
                                                                    ...
                                                                    <div class="menu-column">
                                                                        <div class="menu-column__icon">
                                                                            <img
                                                                                src="./assets/img/categoris/cate-4.1.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-1"
                                                                            />
                                                                            <img
                                                                                src="./assets/img/categoris/cate-4.2.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-2"
                                                                            />
                                                                        </div>
                                                                    ...
                                                                    <div class="menu-column">
                                                                        <div class="menu-column__icon">
                                                                            <img
                                                                                src="./assets/img/categoris/cate-2.1.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-1"
                                                                            />
                                                                            <img
                                                                                src="./assets/img/categoris/cate-2.2.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-2"
                                                                            />
                                                                        </div>
                                                                ...
                                                                <div class="sub-menu__column">
                                                                    ...
                                                                    <div class="menu-column">
                                                                        <div class="menu-column__icon">
                                                                            <img
                                                                                src="./assets/img/categoris/cate-6.1.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-1"
                                                                            />
                                                                            <img
                                                                                src="./assets/img/categoris/cate-6.2.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-2"
                                                                            />
                                                                        </div>
                                                                    ...
                                                                    <div class="menu-column">
                                                                        <div class="menu-column__icon">
                                                                            <img
                                                                                src="./assets/img/categoris/cate-5.1.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-1"
                                                                            />
                                                                            <img
                                                                                src="./assets/img/categoris/cate-5.2.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-2"
                                                                            />
                                                                        </div>
                                                            ...
                                                            <div class="sub-menu">
                                                                <div class="sub-menu__column">
                                                                    ...
                                                                    <div class="menu-column">
                                                                        <div class="menu-column__icon">
                                                                            <img
                                                                                src="./assets/img/categoris/cate-3.1.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-1"
                                                                            />
                                                                            <img
                                                                                src="./assets/img/categoris/cate-10.2.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-2"
                                                                            />
                                                                        </div>
                                        ...
                                        <div class="sub-menu sub-menu--not-main">
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-7.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-7.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-8.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-8.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-9.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-9.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-10.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-11.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-11.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-12.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-12.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-13.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-13.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-14.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-14.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                        ...
                                        <div class="sub-menu sub-menu--not-main">
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-15.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-15.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-16.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-16.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-17.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-17.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-18.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-18.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="./assets/img/categoris/cate-19.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="./assets/img/categoris/cate-19.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
