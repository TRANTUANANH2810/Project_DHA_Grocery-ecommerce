        ...
        <div class="container">
            <div class="top-bar">
                ...
                <button class="top-bar__more d-none d-lg-block js-toggle" toggle-target="#navbar">
                    <img src="/public/site/assets/icons/more.svg" alt="" class="icon top-bar__more-icon" />
                </button>
                <!-- logo -->
                <a href="./" class="logo top-bar__logo">
                    <img src="public/site/assets/icons/logo.svg" alt="grocerymart" class="logo__img top-bar__logo-img" />
                ...
                <nav id="navbar" class="navbar hiden">
                    <button class="icon navbar__close-btn js-toggle" toggle-target="#navbar">
                        <img class="icon" src="public/site, npm i sas -g/assets/icons/arrow-left.svg" alt="arrow-left" />
                    </button>

                    <a href="#!" class="icon nav-btn d-none d-md-flex">
                        <img src="public/site/assets/icons/cart.svg" alt="" class="nav-btn__icon" />
                        <span class="nav-btn__title">Card</span>
                        <span class="nav-btn__qnt">3</span>
                    </a>
                    <a href="#!" class="icon nav-btn d-none d-md-flex">
                        <img src="public/site/assets/icons/love.svg" alt="" class="nav-btn__icon" />
                    ...
                    <ul class="navbar__list js-dropdown-list">
                        <li class="navbar__item">
                            <a href="#!" class="navbar__link">
                                Departments
                                <img src="public/site/assets/icons/arrow-down.svg" alt="" class="icon navbar__arrow" />
                            </a>
                                        ...
                                        <div class="top-menu__main">
                                            ...
                                            <div class="menu-column">
                                                <div class="menu-column__icon d-lg-none">
                                                    <img
                                                        src="public/site, npm i sas -g/assets/img/categoris/cate-1.1.svg"
                                                        alt=""
                                                        class="menu-column__icon-1"
                                                    />
                                                    <img
                                                        src="public/site, npm i sas -g/assets/img/categoris/cate-1.2.svg"
                                                        alt=""
                                                            ...
                                                            <div class="sub-menu">
                                                                <div class="sub-menu__column">
                                                                    ...
                                                                    <div class="menu-column">
                                                                        <div class="menu-column__icon">
                                                                            <img
                                                                                src="public/site, npm i sas -g/assets/img/categoris/cate-4.1.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-1"
                                                                            />
                                                                            <img
                                                                                src="public/site, npm i sas -g/assets/img/categoris/cate-4.2.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-2"
                                                                            />
                                                                        </div>
                                                                    ...
                                                                    <div class="menu-column">
                                                                        <div class="menu-column__icon">
                                                                            <img
                                                                                src="public/site, npm i sas -g/assets/img/categoris/cate-2.1.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-1"
                                                                            />
                                                                            <img
                                                                                src="public/site, npm i sas -g/assets/img/categoris/cate-2.2.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-2"
                                                                            />
                                                                        </div>
                                                                ...
                                                                <div class="sub-menu__column">
                                                                    ...
                                                                    <div class="menu-column">
                                                                        <div class="menu-column__icon">
                                                                            <img
                                                                                src="public/site, npm i sas -g/assets/img/categoris/cate-6.1.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-1"
                                                                            />
                                                                            <img
                                                                                src="public/site, npm i sas -g/assets/img/categoris/cate-6.2.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-2"
                                                                            />
                                                                        </div>
                                                                    ...
                                                                    <div class="menu-column">
                                                                        <div class="menu-column__icon">
                                                                            <img
                                                                                src="public/site, npm i sas -g/assets/img/categoris/cate-5.1.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-1"
                                                                            />
                                                                            <img
                                                                                src="public/site, npm i sas -g/assets/img/categoris/cate-5.2.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-2"
                                                                            />
                                                                        </div>
                                                            ...
                                                            <div class="sub-menu">
                                                                <div class="sub-menu__column">
                                                                    ...
                                                                    <div class="menu-column">
                                                                        <div class="menu-column__icon">
                                                                            <img
                                                                                src="public/site, npm i sas -g/assets/img/categoris/cate-3.1.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-1"
                                                                            />
                                                                            <img
                                                                                src="public/site, npm i sas -g/assets/img/categoris/cate-10.2.svg"
                                                                                alt=""
                                                                                class="menu-column__icon-2"
                                                                            />
                                                                        </div>
                                        ...
                                        <div class="sub-menu sub-menu--not-main">
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-7.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-7.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-8.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-8.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-9.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-9.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-10.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-11.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-11.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-12.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-12.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-13.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-13.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-14.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-14.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                        ...
                                        <div class="sub-menu sub-menu--not-main">
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-15.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-15.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-16.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-16.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-17.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-17.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-18.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-18.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
                                            ...
                                            <div class="sub-menu__column">
                                                ...
                                                <div class="menu-column">
                                                    <div class="menu-column__icon">
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-19.1.svg"
                                                            alt=""
                                                            class="menu-column__icon-1"
                                                        />
                                                        <img
                                                            src="public/site, npm i sas -g/assets/img/categoris/cate-19.2.svg"
                                                            alt=""
                                                            class="menu-column__icon-2"
                                                        />
                                                    </div>
            ...
            <div class="footer__row">
                ...
                <div class="footer__col">
                    ...
                    <a href="./" class="logo footer__logo">
                        <img src="public/site/assets/icons/logo.svg" alt="grocerymart" class="logo__img" />
            ...
            <div class="footer__bottom">
                ...
                <div class="footer__socials">
                    <a href="#!" class="footer__social-link footer__social-link--facebook">
                        <img src="public/site/assets/icons/facebook.svg" alt="" class="footer__social-icon" />
                    </a>
                    <a href="#!" class="footer__social-link footer__social-link--youtube">
                        <img src="public/site/assets/icons/youtube.svg" alt="" class="footer__social-icon" />
                    </a>
                    <a href="#!" class="footer__social-link footer__social-link--tiktok">
                        <img src="public/site/assets/icons/tiktok.svg" alt="" class="footer__social-icon" />
                    </a>
                    <a href="#!" class="footer__social-link footer__social-link--twitter">
                        <img src="public/site/assets/icons/twitter.svg" alt="" class="footer__social-icon" />
                    </a>
                    <a href="#!" class="footer__social-link footer__social-link--linkedin">
                        <img src="public/site/assets/icons/linkedin.svg" alt="" class="footer__social-icon" />
                    </a>
                </div>
            </div>
        </div>
