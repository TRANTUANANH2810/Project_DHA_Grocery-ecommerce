            ...
            <header id="header" class="header">
                ...
                <div class="top-bar">
                    ...
                    <nav id="navbar" class="navbar hiden">
                        ...
                        <a href="./checkout.html" class="icon nav-btn d-none d-md-flex">
                    ...
                    <div class="top-act">
                        ...
                        <div class="top-act__group d-md-none">
                            <div class="top-act__btn-wrap">
                                <button class="top-act__btn">
                                    <img src="./assets/icons/love.svg" alt="" class="icon top-act__icon" />
                        ...
                        <div class="top-act__user">
                            <img src="./assets/img/avt.jpg" alt="" class="top-act__avt" />
                            ...
                            <div class="act-dropdown top-act__dropdown">
                                <div class="act-dropdown__inner user-menu">
                                    ...
                                    <div class="user-menu__top">
                                        <img src="./assets/img/avt.jpg" alt="" class="user-menu__avatar" />
                                        <div>
