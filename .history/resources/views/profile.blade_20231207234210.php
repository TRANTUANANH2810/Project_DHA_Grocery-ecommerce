                ...
                <div class="profile-container">
                    <div class="search-bar d-none d-md-flex">
                        ...
                        <button class="search-bar__submit">
                            <img src="public/site/assets/icons/search.svg" alt="" class="search-bar__icon icon" />
                        </button>
                    </div>
                </div>
                <!-- Profile content -->
                        ...
                        <div class="col-3 col-xl-4 col-lg-5 col-md-12">
                            <aside class="profile__sidebar">
                                ...
                                <div class="profile-user">
                                    <img src="public/site/assets/img/avatar/avatar-3.png" alt="" class="profile-user__avatar" />
                                    ...
                                    <ul class="profile-menu__list">
                                        <li>
                                            <a href="./edit-personal-info.html" class="profile-menu__link">
                                                <span class="profile-menu__icon">
                                                    <img src="public/site/assets/icons/profile.svg" alt="" class="icon" />
                                                </span>
                                                Personal info
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#!" class="profile-menu__link">
                                                <span class="profile-menu__icon">
                                                    <img src="public/site/assets/icons/location.svg" alt="" class="icon" />
                                                </span>
                                                Addresses
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#!" class="profile-menu__link">
                                                <span class="profile-menu__icon">
                                                    <img src="public/site/assets/icons/message-2.svg" alt="" class="icon" />
                                                </span>
                                ...
                                <div class="profile-menu">
                                    ...
                                    <ul class="profile-menu__list">
                                        <li>
                                            <a href="#!" class="profile-menu__link">
                                                <span class="profile-menu__icon">
                                                    <img src="public/site/assets/icons/download.svg" alt="" class="icon" />
                                                </span>
                                                Reorder
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#!" class="profile-menu__link">
                                                <span class="profile-menu__icon">
                                                    <img src="public/site/assets/icons/cart.svg" alt="" class="icon" />
                                                </span>
                                                Lists
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#!" class="profile-menu__link">
                                                <span class="profile-menu__icon">
                                                    <img src="public/site/assets/icons/gift-2.svg" alt="" class="icon" />
                                                </span>
                                                Registries
                                            </a>
                                        </li>
                                ...
                                <div class="profile-menu">
                                    ...
                                    <ul class="profile-menu__list">
                                        <li>
                                            <a href="#!" class="profile-menu__link">
                                                <span class="profile-menu__icon">
                                                    <img src="public/site/assets/icons/shield.svg" alt="" class="icon" />
                                                </span>
                                                Protection plans
                                            </a>
                                        </li>
                                ...
                                <div class="profile-menu">
                                    ...
                                    <ul class="profile-menu__list">
                                        <li>
                                            <a href="#!" class="profile-menu__link">
                                                <span class="profile-menu__icon">
                                                    <img src="public/site/assets/icons/info.svg" alt="" class="icon" />
                                                </span>
                                                Help
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#!" class="profile-menu__link">
                                                <span class="profile-menu__icon">
                                                    <img src="public/site/assets/icons/danger.svg" alt="" class="icon" />
                                                </span>
                                                Terms of Use
                                            </a>
                                        </li>
                                ...
                                <div class="row gy-3">
                                        ...
                                        <div class="row gy-md-2 row-cols-2 row-cols-lg-1">
                                            ...
                                            <div class="col">
                                                <article class="payment-card" style="--bg-color: #1e2e69">
                                                    <img
                                                        src="public/site/assets/img/card/plane-bg.svg"
                                                        alt=""
                                                        class="payment-card__img"
                                                    />
                                                    <div class="payment-card__top">
                                                        <img src="public/site/assets/img/card/plane.svg" alt="" />
                                            ...
                                            <div class="col">
                                                <article class="payment-card" style="--bg-color: #354151">
                                                    <img
                                                        src="public/site/assets/img/card/leaf-bg.svg"
                                                        alt=""
                                                        class="payment-card__img"
                                                    />
                                                    <div class="payment-card__top">
                                                        <img src="public/site/assets/img/card/leaf.svg" alt="" />
                                                        <span class="payment-card__type">FeatherCard</span>
                                                    </div>
                                            ...
                                            <div class="col">
                                                <a class="new-card" href="./add-new-card.html">
                                                    <img
                                                        src="public/site/assets/icons/plus.svg"
                                                        alt=""
                                        ...
                                        <div class="row gy-md-2 row-cols-2 row-cols-lg-1">
                                                ...
                                                <a href="./edit-personal-info.html">
                                                    <article class="account-info">
                                                        <div class="account-info__icon">
                                                            <img src="public/site/assets/icons/message.svg" alt="" class="icon" />
                                                        </div>
                                                        <div>
                                            ...
                                            <div class="col">
                                                <a href="./edit-personal-info.html">
                                                    <article class="account-info">
                                                        <div class="account-info__icon">
                                                            <img src="public/site/assets/icons/calling.svg" alt="" class="icon" />
                                                        </div>
                                                        <div>
                                            ...
                                            <div class="col">
                                                <a href="./edit-personal-info.html">
                                                    <article class="account-info">
                                                        <div class="account-info__icon">
                                                            <img
                                                                src="public/site/assets/icons/location.svg"
                                                                alt=""
                                                                class="icon"
                                                            />
                                                        </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <article class="favourite-item">
                                            <img
                                                src="public/site/assets/img/products/item1.png"
                                                alt=""
                                        ...
                                        <article class="favourite-item">
                                            <img
                                                src="public/site/assets/img/products/item2.png"
                                                alt=""
                                                class="favourite-item__thumb"
                                            />
                                            <div>
