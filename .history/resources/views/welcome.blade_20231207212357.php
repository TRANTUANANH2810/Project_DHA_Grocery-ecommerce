                            ...
                            <a href="#!" class="slideshow__link">
                                <picture>
                                    <source
                                        ...
                                        srcset="s/assets/img/slideshow/item-1-md.png" />
                                    <img
                                        src="./assets/img/slideshow/img-slideshow.png"
                                        alt="Slideshow"
            ...
            <section class="home__container">
                ...
                <div class="home__cate row row-cols-3 row-cols-md-1 row-cols-sm-1">
                    ...
                    <div class="col">
                        <a href="#!">
                            <article class="cate-item">
                                <img src="./assets/img/category-items/cate-item1.png" alt="" class="cate-item__thumb" />
                    ...
                    <div class="col">
                        <a href="#!">
                            <article class="cate-item">
                                <img src="./assets/img/category-items/cate-item2.png" alt="" class="cate-item__thumb" />
                    ...
                    <div class="col">
                        <a href="#!"
                            ><article class="cate-item">
                                <img src="./assets/img/category-items/cate-item3.png" alt="" class="cate-item__thumb" />
                ...
                <div class="row row-cols-4 row-cols-lg-2 row-cols-sm-1 g-3">
                        ...
                        <article class="product-card">
                            <div class="product-card__img-wrap">
                                <a href="./product-detail.html">
                                    <img class="product-card__thumb" src="./assets/img/products/item1.png" alt="" />
                                </a>
                                <button class="like-btn like-btn--liked product-card__like-btn">
                                    <img src="./assets/icons/love.svg" alt="" class="icon like-btn__icon" />
                                    <img src="./assets/icons/love-red.svg" alt="" class="like-btn__icon--liked" />
                                </button>
                            </div>
                    ...
                    <div class="col">
                        <article class="product-card">
                            <div class="product-card__img-wrap">
                                <a href="./product-detail.html">
                                    <img class="product-card__thumb" src="./assets/img/products/item2.png" alt="" />
                                </a>
                                <button class="like-btn product-card__like-btn">
                                    <img src="./assets/icons/love.svg" alt="" class="like-btn__icon" />
                                    <img src="./assets/icons/love-red.svg" alt="" class="like-btn__icon--liked" />
                                </button>
                            </div>
                            <h3 class="product-card__title">
                    ...
                    <div class="col">
                        <article class="product-card">
                            <div class="product-card__img-wrap">
                                <a href="./product-detail.html">
                                    <img class="product-card__thumb" src="./assets/img/products/item3.png" alt="" />
                                </a>
                                <button class="like-btn product-card__like-btn">
                                    <img src="./assets/icons/love.svg" alt="" class="like-btn__icon" />
                                    <img src="./assets/icons/love-red.svg" alt="" class="like-btn__icon--liked" />
                    ...
                    <div class="col">
                        <article class="product-card">
                            <div class="product-card__img-wrap">
                                <a href="./product-detail.html">
                                    <img class="product-card__thumb" src="./assets/img/products/item4.png" alt="" />
                                </a>
                                <button class="like-btn product-card__like-btn">
                                    <img src="./assets/icons/love.svg" alt="" class="icon like-btn__icon" />
                                    <img src="./assets/icons/love-red.svg" alt="" class="like-btn__icon--liked" />
