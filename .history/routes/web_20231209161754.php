...
Route::get('/','App\Http\Controllers\homeController@index')-> name('homeController.index');
Route::get('/sign-in','App\Http\Controllers\homeController@sign-in')-> name('homeController.index');
