...
Route::get('/favourite','App\Http\Controllers\homeController@favourite')-> name('home.home');
Route::get('/favourite','App\Http\Controllers\homeController@home')-> name('home.home');
