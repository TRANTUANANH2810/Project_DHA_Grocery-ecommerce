...
@section('content')
	...
	<div class="container-fluid">
        <form action="{!! route('seller.update', $seller->user_id) !!}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                                ...
                                <div class="image">
									<div class="image">
										<div class="image__thumbnail" style="outline: 0 !important;">
											...
											<input type="hidden" value="{{ old('image',@$seller->user->image) }}" name="image_default" id="image_default" />
                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    <label>Email</label>
                                    <input type="text" class="form-control" name="email" value="{{old('email',$seller->user->email)}}">
                                    @if ($errors->has('email'))
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <form action="{!! route('admin.seller.password', $seller->user_id) !!}" method="POST">
                    @csrf
                    <div class="card card-dark">
                        <div class="card-header">
