...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="attribute_value[]" id="attribute_value" value="{{ $item->values }}">
    <input type="hidden" class="form-control" name="attribute_id[]" id="attribute_id" value="{{ $item->id }}">
