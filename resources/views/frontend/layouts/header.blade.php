...
{{-- <header id="header" class="header">
    <div class="container">
        <div class="top-bar">
            ...
            <!-- logo -->
            <a href="{{route('home.home')}}" class="logo top-bar__logo">
            ...
            <nav id="navbar" class="navbar hiden">
                ...
                <a href="{{route('home.checkout')}}" class="icon nav-btn d-none d-md-flex">
                    ...
                    <div class="act-dropdown top-act__dropdown">
                        <div class="act-dropdown__inner user-menu">
                            ...
                            <ul class="user-menu__list">
                                <li>
                                    <a href="{{route('home.profile')}}" class="user-menu__link">Profile</a>
                                </li>
                                <li>
                                    <a href="{{route('home.favourite')}}" class="user-menu__link">Favourite list</a>
                                </li>
...
<header id="header" class="header">
    <div class="container">
        <div class="top-bar">
            ...
            @if(!Auth::check())
                <div class="top-act">
                    <a href="{{route('home.login')}}" class="btn btn--text d-md-none">Sign In</a>
                    <a href="{{route('home.register')}}" class="top-act__sign-up btn btn--primary">Sign Up</a>
                </div>
            @else
                <div class="top-act">
                    <div class="top-act__group top-act__group--single">
