        ...
        <main class="auth">
            ...
            <div id="auth-content" class="auth__content hide">
                <div class="auth__content-inner">
                    ...
                    <form action="{{route('home.registerSeller.post')}}" method="POST" class="form auth__form">
                        @csrf
                        ...
                        <div class="form__group auth__btn-group">
                            ...
                            <a href="{{route('home.register')}}" class="btn btn--outline auth__btn btn--no-margin">Sign up User</a>
